...
| Social feed | Current LB API/web + official Android/KMP behavior | Event taxonomy, cursor semantics, actor/recording identity; no GPL UI copied | Native music-first My Feed/Following/Similar cards, one request per page, bounded cache/dedupe |
