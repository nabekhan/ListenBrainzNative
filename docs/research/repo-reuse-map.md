...
| API/domain | ListenBrainzKit | Existing P0 clients/models | Reliability fixes, app adapters, typed CF/social/pins/detail/era-stat extensions |
...
| Stats/heatmap/eras | Autohop MIT patterns + current LB API/web behavior + native Swift Charts | Period/history hierarchy and chart interaction concepts; no donor code copied | Typed daily/era adapters, normalized cached UTC 7×24 heatmap, server activity charts, categorical decade bars, and decade-to-year drill-down |
