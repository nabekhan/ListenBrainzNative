...
| Playlist lists/search/detail | SUPPORTED | User/created-for/collaborator/recommendation listings, public search, and complete typed JSPF detail/track payloads; generated playlists feed the native For You view | Reuse; detail extension is an upstream candidate |
...
| Feed mutations (thanks/hide/unhide/delete/recommendations) | MISSING | Read-only feed is covered; write actions remain unimplemented | Add after read experience |
| Recommendations and feedback | PARTIALLY_SUPPORTED | Typed, paginated CF recording retrieval is implemented; recommendation feedback remains absent | Reuse native For You read slice; add feedback separately |
