...
- ListenBrainzKit, commit `c06b12f8c35bfee8fcf11dc973b5d78e23719cdf`, is vendored at `Packages/ListenBrainzKit/` and locally patched for transport correctness, public model access, tolerant identifier decoding, and typed social, social feed-read, Pins, detail, Fresh Releases, recommendation-read, and recommendation-feedback APIs. It is licensed under MPL-2.0; its original license and per-file notices are preserved.
