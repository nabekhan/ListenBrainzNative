...
- Current ListenBrainz and CritiqueBrainz server behavior informed the official review-broker contract, legal-consent meaning, language/rating bounds, and uncertain-delivery handling. The Swift transport extension, native composer, consent, journal, and recovery UI are independently implemented; no GPL server, web, KMP, or client source was copied.
